...
var _user$project$BooleanParser$evalTerm = function (term) {
	var _p0 = term;
	switch (_p0.ctor) {
		case 'T':
			return true;
		case 'F':
			return false;
		case 'Not':
			return !_user$project$BooleanParser$evalTerm(_p0._0);
		case 'And':
			return _user$project$BooleanParser$evalTerm(_p0._0) && _user$project$BooleanParser$evalTerm(_p0._1);
		default:
			return _user$project$BooleanParser$evalTerm(_p0._0) || _user$project$BooleanParser$evalTerm(_p0._1);
	}
};
var _user$project$BooleanParser$spaces = A2(
...
var _user$project$BooleanParser$Or = F2(
	function (a, b) {
		return {ctor: 'Or', _0: a, _1: b};
	});
var _user$project$BooleanParser$And = F2(
	function (a, b) {
		return {ctor: 'And', _0: a, _1: b};
	});
var _user$project$BooleanParser$Not = function (a) {
...
var _user$project$Main$examples = A2(
	...
	{ctor: '[]'},
	{
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('T && T \\(\\rightarrow True \\land True \\Rightarrow True \\)'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _user$project$Main$descriptions = function () {
	...
	function (msg, model) {
		...
		if (_p0.ctor === 'Change_input') {
			...
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					result: _user$project$BooleanParser$evalString(model.input_)
				});
		}
	});
var _user$project$Main$model = {input_: '', result: ''};
var _user$project$Main$Model = F2(
	function (a, b) {
		return {input_: a, result: b};
	});
var _user$project$Main$Submit = {ctor: 'Submit'};
var _user$project$Main$Change_input = function (a) {
	return {ctor: 'Change_input', _0: a};
};
var _user$project$Main$view = function (model) {
	var buttonStyle = _elm_lang$html$Html_Attributes$style(
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'margin', _1: 'auto 20px'},
			_1: {ctor: '[]'}
		});
		...
		},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$Change_input),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$type_('text'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$value(model.input_),
									_1: {
										ctor: '::',
										_0: inputStyle,
										_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('評価'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					_user$project$Main$descriptions),
				_1: {
					ctor: '::',
					_0: A2(
